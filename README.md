Принято. Составляю детальное руководство по созданию исчерпывающего README.md для проекта whisper-core-server согласно заданному формату с акцентом на best practices.
...
**На Windows-станции (192.168.1.3):**
...
1. Откройте Grafana: http://192.168.1.6:3000
...
smbclient -L //192.168.1.6/ -U whisper
```
